 ...
 * Policy and Terms (linked to boundlessmissions.com/pp and /tos), tick every
 * agreement box, and accept before any data is gathered or a Discord account
...
namespace GeneKerman.UI
{
    ...
    {
        private Rect windowRect = new Rect(Screen.width / 2 - 260, Screen.height / 2 - 335, 520, 670);
        private readonly int windowId = "GKConsent".GetHashCode();

        // The four unambiguous opt-in checkboxes (rule 8.1).
        ...
        private bool agreePromotion;      // licence to show shared crafts in promo material
        ...
        public void Draw()
        {
            ...
            windowRect = ClickThroughHelper.Window(windowId, windowRect, DrawWindowContent, "",
                GUIStyle.none, GUILayout.Width(520), GUILayout.Height(670));
        }
        ...
        private void DrawWindowContent(int id)
        {
            ...
            GUILayout.Label(
                ...
                "• Your Discord display name, profile picture and corp name: stored and shown " +
                "to other players in the in-game player lists used to send a craft, offer a " +
                "contract or issue a rescue, and beside what you list or bid on\n" +
                "• A random device identifier (account security only; it is generated by " +
                "this add-on and is not read from your hardware)\n" +
                ...
                "Gemini AI\n" +
                "• Your KSP.log, only inside a report you or the account owner files: a " +
                "bug report attaches your (trimmed) log, and a device report collects the " +
            ...
            agreeTransmission = GUILayout.Toggle(agreeTransmission,
                ...
                checkStyle);
            GUILayout.Space(6);
            agreePromotion = GUILayout.Toggle(agreePromotion,
                " I grant Boundless Missions the right to show the crafts I share, and the " +
                "renders and screenshots that come with them, in material promoting " +
                "Boundless Missions.",
                checkStyle);
            ...
            GUILayout.BeginHorizontal();
            GUI.enabled = agreePrivacy && agreeTerms && agreeTransmission && agreePromotion;
